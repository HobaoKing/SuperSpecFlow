...
|---|---|---|---|---|
| SSF-ROLE-GATE-001 | Runtime guidance uses SuperSpecFlow role gates | `AGENTS.md`, `routing/AGENTS.routing.md`, `routing/CLAUDE.routing.md`, `skills/ssf-think/SKILL.md`, `skills/ssf-review/SKILL.md`, `skills/ssf-ship/SKILL.md`, `skills/ssf-git/SKILL.md`, `skills/ssf-karpathy/SKILL.md`, `README.md` | `tests/routing/test_role_gate_source_boundary.bats`, `rtk bash scripts/validate-pack.sh` | Implemented |
...
| SSF-ROLE-GATE-N2 | Role gates are not removed | Runtime docs and skills | `tests/routing/test_role_gate_source_boundary.bats` | Implemented |
