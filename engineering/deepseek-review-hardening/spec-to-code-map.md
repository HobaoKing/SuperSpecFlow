...
| SSF-DEEPSEEK-003 | Command contract coverage | `commands/ssf-branch.md`, `commands/ssf-decision.md`, `commands/ssf-map.md`, `scripts/validate-pack.sh` | `tests/review/test_deepseek_review_hardening.bats` | Implemented |
...
| SSF-DEEPSEEK-005 | Documentation naming consistency | `README.md`, `templates/design.md`, `scripts/validate-pack.sh` | `tests/review/test_deepseek_review_hardening.bats` | Implemented |
