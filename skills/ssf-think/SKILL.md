---
name: ssf-think
description: 阶段一（想）。用户输入 /ssf-think 或描述新想法/新功能时触发。用 SuperSpecFlow 产品门禁做价值、体验、范围反问，产出 Product Change Brief、Decision Record 和 design.md，然后进入 ssf-spec。
---
...
本阶段执行 SuperSpecFlow 产品门禁：不是顺着用户写功能，而是从价值、体验、范围视角挑战价值、压缩范围、识别伪需求。
...
注意：reviewer prompt 是英文，针对单一 design.md 结构（跟本阶段产物吻合度较高）。如反复给出与项目中文化或 SuperSpecFlow 产品三重门禁无关的反馈，记录 follow-up。
